...
(function() {
    ...
    var AdvArraw = new Array(
        ...
        'a[href*="@"][href$="exe"],div[id^="_"][style="width: 100%;"]>iframe,iframe[src*="pos.baidu.com"],a[href*="i/?cid="],iframe[src*="/ads?"],iframe[src*="v.php?id="],iframe[src*="s.php?id="],[id^="BAIDU_"],iframe[src*="/ad/"],iframe[src*="adurl"][src*="type="],[node-type^="ad"]',
        'div[class*="_adv_"],div[class*="-adv-"],div[class*="-ad-"],div[class*="_ad_"]',
